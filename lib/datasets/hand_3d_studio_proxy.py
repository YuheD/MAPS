...
class Hand3DStudio_proxy(Hand21KeypointDataset):
    ...
    .. note:: In `root`, there will exist following files after downloading.
        ::
            H3D_crop/
                ...
                part5/
    """
    def __init__(self, root, tgt_list=None, split='train', task='noobject', download=True,  k=1, 
        ...
        super(Hand3DStudio_proxy, self).__init__(root, samples, **kwargs)
        # print(self.root)
...
class Hand3DStudioAll_proxy(Hand3DStudio_proxy):
    """
    `Hand-3d-Studio Dataset <https://www.yangangwang.com/papers/ZHAO-H3S-2020-02.html>`_

    """
    def __init__(self,  root, task='all', **kwargs):
        super(Hand3DStudioAll_proxy, self).__init__(root, task=task, **kwargs)