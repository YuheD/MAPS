...
class Hand3DStudio(Hand21KeypointDataset):
    ...
    .. note:: In `root`, there will exist following files after downloading.
        ::
            H3D_crop/
                ...
                part5/
    """
    def __init__(self, root, tgt_list=None, split='train', task='noobject', download=False, **kwargs):
    ...
    def __getitem__(self, index):
        ...
        meta = {
            'image': image_name,
            'target_small': generate_target(keypoint2d, visible, (8, 8), self.sigma, self.image_size),
