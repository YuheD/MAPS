...
class Hand3DStudio_proxy_kp(Hand21KeypointDataset):
    ...
    .. note:: In `root`, there will exist following files after downloading.
        ::
            H3D_crop/
                ...
                part5/
    """
    def __init__(self, root, tgt_list=None, weights=None, split='train', task='noobject', download=True,  k=1, 
                    transforms_base=None, transforms_stu=None, transforms_tea=None, label_transform=None, **kwargs):
        ...
        self.transforms_lb = label_transform
        self.k = k

        super(Hand3DStudio_proxy_kp, self).__init__(root, samples, **kwargs)
        # print(self.root)
    ...
    def __getitem__(self, index):
        ...
        img_lb, _ = self.transforms_lb(image, keypoint2d=keypoint2d, intrinsic_matrix=intrinsic_matrix)
        ...
        target_weight_stu = self.weights[index]
        # print(target_weight_stu)
        # exit(0)
        return image_stu, target_stu, target_weight_stu, meta_stu, images_tea, targets_tea, target_weights_tea, metas_tea, img_lb


class Hand3DStudioAll_proxy_kp(Hand3DStudio_proxy_kp):
    """
    `Hand-3d-Studio Dataset <https://www.yangangwang.com/papers/ZHAO-H3S-2020-02.html>`_

    """
    def __init__(self,  root, task='all', **kwargs):
        super(Hand3DStudio_proxy_kp, self).__init__(root, task=task, **kwargs)